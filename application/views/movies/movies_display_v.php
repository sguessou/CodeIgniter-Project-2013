...
<div class="wrapper">
		<div class="product">
			...
			<a class="add-cart" href="<?= $base_url ?>/welcome/add_to_cart/<?= $product_data[0]['product_id'] ?>/<?= $product_data[0]['product_price'] ?>/<?php echo urlencode($product_data[0]['product_name']); ?>/<?=$product_data[0]['type_name']?>/Dvd/">Add to cart</a>
