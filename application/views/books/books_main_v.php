...
<h3><strong>IT-Books:</strong></h3>
	...
	<?php
	    ...
	    echo '<br /><a class="add-cart-book" href="'.$base_url.'/welcome/add_to_cart/'.$product['product_id'].'/'.$product['product_price'].'/'.urlencode($product['product_name']).'/'.$product['type_name'].'/Book/">Add to cart</a>';
	    echo '</li>';	
	   }
	?>		
	</ul>
