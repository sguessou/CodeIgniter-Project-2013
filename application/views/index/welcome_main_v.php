...
<div id="menu"> 
	...
	<div id="feature">	
		<div class="left">		
			...
			<ul class="cartUl">                            
				<li><a href=""><img src="<?= $base_url.'/css/images/bin_closed.png' ?>"></a>&nbsp;&nbsp;<a href="" id="cSlider">product name</a>
				&nbsp;<strong><?php echo $cart_total_items. ($cart_total_items == 1 ? ' Item ' : ' Items '); ?></strong>à&nbsp;€&nbsp;
				price&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Subtotal:</strong>&nbsp;
				<font color="#FF0000"><strong>€&nbsp;<?= $cart_total ?></strong></font></li>		
				<li>&nbsp;</li>
				<li><strong>Total Sum: € <font color="#FF0000"><?php echo $cart_total; ?></strong></font></li>
			</ul>
